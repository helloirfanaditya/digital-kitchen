...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/landing/css/pe-icon-7-stroke.cs') }}s" />
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/landing/css/owl.carousel.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/landing/css/owl.theme.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/landing/css/owl.transitions.css') }}">
