...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="{{ asset('assets/dashboard/libs/datatables/dataTables.bootstrap4.min.css') }}" rel="stylesheet" type="text/css"/>
        <link href="{{ asset('assets/dashboard/libs/datatables/responsive.bootstrap4.min.css') }}" rel="stylesheet" type="text/css"/>
